            ...
            <table class="table table-dark table_admin table-striped">
                ...
                for ($i = 0; $i < $info_users['compte']; $i++) {
                    ...
                    <tr>
                        ...
                        <td class=" sup">
                            <button><a class="icon-trash"
                                       href="suppression.php?id_user=<?= $info_users['recup'][$i]["id"] ?>"
                                       title="supprimer"
                                       onclick="return confirm('Supprimer : <?= $info_users['recup'][$i]['username'] ?> ?')"><img
                                            src="src/images/trash.png" alt="logo poubelle"></a></button>
                        </td>
                    </tr>
                    <?php
                }
        ...
        <section class="pagination">
            <table class="table table_admin table-dark table-striped">
                ...
                for ($i = 0; $i < $info_scores["compte"]; $i++) {
                    ...
                    $general_score = $bdd->query(
                        'SELECT count(score) as place FROM score WHERE score>? AND nb_paires=?',
                        [$score_gen, $nb_paire_gen]
                    ...
                    <tr>
                        ...
                        <td class=" sup">
                            <button><a class="icon-trash"
                                       href="suppression.php?id_score=<?= $info_scores["recup"][$i]["id"] ?>"
                                       title="supprimer" onclick="return confirm('Supprimer : Ce score ?')"><img
                                            src="src/images/trash.png" alt="logo poubelle"></a></button>
                        </td>
                    </tr>
                    <?php
    ...
    <section id="ad_paires">
        <section id="form_paires">
            ...
            if (isset($e)) {
                ...
                if (!isset($e) && isset($_POST["valid_img"])) {
        ...
        <section class="pagination">
            <table class="table table-dark table-striped table_paires">
                ...
                for ($i = 0; $i < $info_paires["compte"]; $i++) {
                    ?>
                    <tr>
                        <td><img class="paires_admin" src="<?= $info_paires["recup"][$i]["image_path"] ?>"
                                 alt="photo paires"></td>
                        <td class=" sup">
                            <button><a class="icon-trash"
                                       href="suppression.php?id_paires=<?= $info_paires["recup"][$i]["id"] ?>&page=<?= $retour_page ?>"
                                       title="supprimer" onclick="return confirm('Supprimer : Cette paire ?')"><img
                                            src="src/images/trash.png" alt="logo poubelle"></a></button>
                        </td>
                    </tr>
                    <?php
