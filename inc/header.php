<nav class="navbar position-absolute">
    <div class="flex-grow-1"><a class="text-decoration-none <?= $page_selected == 'index' ? 'navbar_selected' : '' ?>" href="Index.php">ACCUEIL</a></div>
    <div class="<?= (App::getAuth()->user()) ? '' : 'd-none' ?> <?= $page_selected == 'memory' ? 'navbar_selected' : '' ?> flex-grow-1"><a class="text-decoration-none" href="memory.php">MEMORY</a>
    </div>
    ...
    <div class="<?= (App::getAuth()->user()) ? 'd-none' : '' ?> <?= $page_selected == 'connexion' ? 'navbar_selected' : '' ?> flex-grow-1"><a class="text-decoration-none"
                                                                    href="connexion.php">CONNEXION</a></div>
    <div class="<?= (App::getAuth()->user()) ? 'd-none' : '' ?> <?= $page_selected == 'inscription' ? 'navbar_selected' : '' ?> flex-grow-1"><a class="text-decoration-none"
